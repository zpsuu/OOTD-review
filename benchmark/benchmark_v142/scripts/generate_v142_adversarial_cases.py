"""Generate v1.42 adversarial raw artifacts from mixed_strict defects."""
...
DEFAULT_SOURCE_DIR = Path("benchmark/benchmark_v142/results/v142_release_candidate")
...
def build(source_dir: Path) -> None:
    ...
    manifest = {"version": "v1.42", "generated_at": now_iso(), "source_result_dir": str(source_dir), "cases": []}
