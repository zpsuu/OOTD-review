"""Generate v1.40 adversarial raw artifacts from mixed_strict defects."""
...
DEFAULT_SOURCE_DIR = Path("benchmark/benchmark_v140/results/v140_release_candidate")
...
def build(source_dir: Path) -> None:
    ...
    manifest = {"version": "v1.40", "generated_at": now_iso(), "source_result_dir": str(source_dir), "cases": []}
