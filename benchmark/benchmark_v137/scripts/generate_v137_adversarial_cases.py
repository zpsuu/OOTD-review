"""Generate v1.37 adversarial raw artifacts from mixed_strict defects."""
...
DEFAULT_SOURCE_DIR = Path("benchmark/benchmark_v137/results/v137_release_candidate")
...
def build(source_dir: Path) -> None:
    ...
    manifest = {"version": "v1.37", "generated_at": now_iso(), "source_result_dir": str(source_dir), "cases": []}
        ...
        manifest["cases"].append(
            {
                ...
                "artifact_ref": str(out.relative_to(source_dir)),
                "defect_type": case.get("defect_type"),
                "expected_failed_check_ids": case.get("expected_failed_check_ids", []),
            }
        )
