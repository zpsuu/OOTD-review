"""Generate v1.38 adversarial raw artifacts from mixed_strict defects."""
...
DEFAULT_SOURCE_DIR = Path("benchmark/benchmark_v138/results/v138_release_candidate")
...
def build(source_dir: Path) -> None:
    ...
    manifest = {"version": "v1.38", "generated_at": now_iso(), "source_result_dir": str(source_dir), "cases": []}
