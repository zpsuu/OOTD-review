"""Generate v1.43 adversarial raw artifacts from mixed_strict defects."""
...
DEFAULT_SOURCE_DIR = Path("benchmark/benchmark_v143/results/v143_release_candidate")
...
def build(source_dir: Path) -> None:
    ...
    manifest = {"version": "v1.43", "generated_at": now_iso(), "source_result_dir": str(source_dir), "cases": []}
